...
| grammaire | S | **간접화법 시제 일치** (과거 주절→종속절 뒤로): 현재→**반과거**/미래→**조건법**/과거→**대과거** · **시간부사도 backshift**(demain→le lendemain·hier→la veille·aujourd'hui→ce jour-là) | qu'il **mentait** / s'il **viendrait le lendemain** / qu'il **était parti** | qu'il a menti·si c'est vrai ❌(8/13) / 8/18 워밍업 était·viendrait·était parti ✅ | 2026-08-13 | 2026-08-21 | 1 |
| grammaire | S | **de + 관사** 디폴트=관사(du/des/de la); **무관사는 6가지만**: ①부정 ②양·용기 ③합성머리명사(cours/prof de X) ④관용구 ⑤소유격/지시사 ⑥고유명사 | vient des hormones / du corps humain / de la dopamine — 프랑스어는 총칭·물질도 관사 | de+le=du는 **le=관사**일 때만(le=대명사면 X: de le vendre) / 첫 명사가 결정(histoire de la danse↔prof de danse) | 2026-08-18 | 2026-08-21 | 1 |
...
| grammaire | W | (se) comparer **à** (comparer는 목적어 필요; 자기 비교=se comparer à) | ils peuvent se comparer **au** passé | comparer avec le passé(목적어 없음) ❌ (8/18) | 2026-08-18 | 2026-08-19 | 0 |
...
| grammaire | W | **비인칭 가주어 il/c'est**: 뒤에 **동사만**(de+원형 / que+접속법절), **명사 못 옴**, **불변 단수** | il est important de faire / que tu fasses | ce sont importants que + 명사 ❌ (8/18) | 2026-08-18 | 2026-08-19 | 0 |
| grammaire | W | **명사 생략 = 지시대명사** celui(남단)/celle(여단)/ceux(남복)/**celles**(여복) + pour/de/qui | des formules … à **celles** pour les avancés | aux pour avancées ❌ (8/18, 관사+전치사 방치) | 2026-08-18 | 2026-08-19 | 0 |
| grammaire | W | **강조 mise en relief**: 강조 대상=**주어→qui** / 비주어→**que** · 긴 명사 주어 미루기=**의사분열문 Ce qui est important, ce sont [명사]** | Ce sont X et Y **qui** sont importantes / C'est pour… **que** … | qui/que 혼동, 비인칭과 섞음 (8/18) | 2026-08-18 | 2026-08-19 | 0 |
